...
public class Card {
    ...
    public static Card turtle = new Card(6, 1, 2, "Turtle", Sigil.BRAMBLE, new Image(Objects.requireNonNull(Card.class.getResourceAsStream("/images/turtle.png"))), new Image(Objects.requireNonNull(Card.class.getResourceAsStream("/images/noSigil.png"))));
